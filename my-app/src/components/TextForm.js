    ...
    return (
        ...
        <div className="container" style={{color:props.mode==='dark'?'white':'black'}}>
            ...
            <div className="form-group">
                ...
                <button className='btn btn-primary mx-2' style={{color:props.mode==='dark'?'white':'black'}} onClick={AClick}>Convert to Uppercase</button>
                <button className='btn btn-primary mx-2' style={{color:props.mode==='dark'?'white':'black'}} onClick={AClick1}>Convert to Lowercase</button>
                <button className='btn btn-primary mx-2'style={{color:props.mode==='dark'?'white':'black'}} onClick={speak}>Speak</button>
                <button className='btn btn-primary mx-2' style={{color:props.mode==='dark'?'white':'black'}} onClick={stop}>Stop</button>
            </div>
        </div>
